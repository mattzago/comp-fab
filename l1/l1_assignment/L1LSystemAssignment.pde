...
void setup() {
  ...
  // Example Sketch (uncomment to run)
  // lSys = initSquare();
  
  // Sketch A (uncomment to run)
  // lSys = initA();
  
  // Sketch B (uncomment to run)
  // lSys = initB();
  
  // Sketch C (uncomment to run)
  // lSys = initC();
  
  // Sketch D (the probabilistic sketch) (uncomment to run)
  lSys = initD();
